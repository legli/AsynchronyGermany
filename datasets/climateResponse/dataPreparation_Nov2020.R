...
write.xlsx(dfSuitTemp,"datasets/climateResponse/dfSuitabilityTemperature_Nov2020.xlsx",row.names = F)
...
write.xlsx(dfSuitPrec,"datasets/climateResponse/dfSuitabilityPrecipitation_Nov2020.xlsx",row.names = F)
